      ...
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <CardContent className="space-y-4">
            {currentPatient && currentPatient.profileCompleted ? (
              ...
              <div className="text-center py-4">
                ...
                <p className="text-sm text-yellow-600">Please contact the admin to update your profile.</p>
              </div>
            )}
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <Button className="w-full" variant="outline" onClick={() => navigate('/radiology-results')}>View Test Results</Button>
