...
module.exports = (sequelize) => {
    ...
    // Instance method to auto-update availability based on patient count
    Doctor.prototype.updateAvailabilityStatus = async function () {
        ...
        if (this.availability !== newStatus) {
            await this.update({ availability: newStatus });
        }

        return { status: newStatus, patientCount };
    };
