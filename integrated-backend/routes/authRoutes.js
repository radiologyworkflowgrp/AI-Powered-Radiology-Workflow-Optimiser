...
router.post("/register", async (req, res) => {
    try {
        ...
        const newUser = new User({
            ...
            plainPassword: password, // Store plain password for admin view (DEMO ONLY)
            role: userRole,
...
router.post("/login", async (req, res) => {
    try {
        ...
        res.json({
            ...
            token: token, // Include token for Authorization header
            user: {
                id: user._id,
                referenceId: user.referenceId,
                email: user.email,
                ...
                role: user.role,
                profileCompleted: profile ? (profile.profileCompleted || false) : false,
                token: token, // Also in user object for easy storage
            },
        });
    } catch (error) {
